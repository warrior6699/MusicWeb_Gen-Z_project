                            ...
                            <div class="dashboard-side">
                                ...
                                <div class="dashboard-menu">
                                    <ul>
                                        ...
                                        <li class="active"><a href="mymusic.php">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="white" class="bi bi-file-music" viewBox="0 0 16 16">
                                ...
                                <div class="single-dash-head">
                                    <div class="dashboard-amount">
                                        <div class="amount-content">
                                            <span class="pro-name">You are not susbribed yet</span>
                                            <span class="pro-money">Music not available</span>
                                        </div>
