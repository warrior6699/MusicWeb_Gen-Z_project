                            ...
                            <div class="dashboard-side">
                                ...
                                <div class="dashboard-menu">
                                    <ul>
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="red" class="bi bi-person-square" viewBox="0 0 16 16">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="white" class="bi bi-cart-check" viewBox="0 0 16 16">
                        ...
                        <div class="dashboard-top">
                                ...
                                <div class="single-dash-head">
                                    <div class="dashboard-amount">
                                        <div class="amount-content">
                                            <span class="pro-name">Yearly suscription plan</span>
                                            <span class="pro-money">$100/yr</span>
                                            <p>free music dowload for a year</p>
                                        </div>
                                        <div class="invest-tumb">
                                          
                                            <a href="https://buy.stripe.com/test_3csfZ16pcdbXc2A7st" class="btn btn-light">pay</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col">
                                <div class="single-dash-head">
                                    <div class="dashboard-amount">
                                        <div class="amount-content">
                                            <span class="pro-name">Monthly suscription plan</span>
                                            <span class="pro-money">$70/Mn</span>
                                            <p>free music dowload for a month</p>
                                        </div>
                                        <div class="invest-tumb">
                                            
                                            <a href="https://buy.stripe.com/test_6oE9AD6pcfk55Ec7su" class="btn btn-light">pay</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col">
                                <div class="single-dash-head">
                                    <div class="dashboard-amount">
                                        <div class="amount-content">
                                            <span class="pro-name">Weekly suscription plan</span>
                                            <span class="pro-money">$50/yr</span>
                                            <p>free music dowload for a week</p>
                                        </div>
                                        <div class="invest-tumb">
                                           
                                            <a href="https://buy.stripe.com/test_00gaEHbJwb3Pd6E7sv" class="btn btn-light">pay</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
